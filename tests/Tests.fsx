...
#r @"..\bin\FSharp.Data.SqlEnumProvider.dll"
...
type ShipMethod = SqlEnumProvider<"SELECT Name, ShipMethodID AS UTC FROM Purchasing.ShipMethod ORDER BY ShipMethodID", adventureWorks>
...
type OrderHeader = SqlCommandProvider<"SELECT * FROM Purchasing.PurchaseOrderHeader WHERE ShipDate > @shippedLaterThan", adventureWorks>

let cmd = new OrderHeader() 
